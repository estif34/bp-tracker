<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="mb-6">
                <h3 class="text-lg font-bold text-gray-900">Welcome to Your Blood Pressure Tracker</h3>
                <p class="text-gray-600">Monitor, track, and analyze your blood pressure readings over time.</p>
            </div>
            ...
            @if($latestReading)
                ...
                @endphp
                <div class="mb-8 bg-gray-50 rounded-lg shadow p-4">
    ...
    <div class="mt-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-900 mb-4">Healthy Blood Pressure Tips</h3>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex p-4 bg-gray-50 rounded-lg">
