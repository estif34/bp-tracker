                    ...
                    <form method="POST" action="{{ route('blood-pressure.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input id="systolic" type="number" 
                                   ...
                                   name="systolic" value="{{ old('systolic') }}" required min="50" max="250">
                            @error('systolic')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input id="diastolic" type="number" 
                                   ...
                                   name="diastolic" value="{{ old('diastolic') }}" required min="30" max="150">
                            @error('diastolic')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input id="heart_rate" type="number" 
                                   ...
                                   name="heart_rate" value="{{ old('heart_rate') }}" min="30" max="220">
                            @error('heart_rate')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="note" name="note" rows="3" 
                                     class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('note') border-red-500 @enderror">{{ old('note') }}</textarea>
                            @error('note')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
